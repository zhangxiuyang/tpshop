<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:43:"./application/admin/view3/coupon\index.html";i:1503927232;s:48:"./application/admin/view3/public\min-header.html";i:1510128324;s:48:"./application/admin/view3/public\breadcrumb.html";i:1509608949;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if($list[type] == 4): ?>
                                                <a href="<?php echo U('Admin/Coupon/make_coupon',array('id'=>$list['id'],'type'=>$list['type'])); ?>" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="发放"><i class="fa fa-send"></i></a>
