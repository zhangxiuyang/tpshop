<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./application/admin/view3/order\ajaxindex.html";i:1503927232;}*/ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                           ...
                                           <?php if(($list['order_status'] == 3) or ($list['order_status'] == 5)): ?>
                                                <a href="<?php echo U('Admin/order/delete_order',array('order_id'=>$list['order_id'])); ?>"  data-toggle="tooltip" class="btn btn-danger" title="删除"><i class="fa fa-trash-o"></i></a>
                                        	<?php else: ?>
