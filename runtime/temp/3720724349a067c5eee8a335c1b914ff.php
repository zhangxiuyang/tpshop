<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/view3/comment\index.html";i:1503927232;s:48:"./application/admin/view3/public\min-header.html";i:1509601837;s:48:"./application/admin/view3/public\breadcrumb.html";i:1509608949;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($comment_list) || $comment_list instanceof \think\Collection || $comment_list instanceof \think\Paginator): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img width="20" height="20" src="__PUBLIC__/images/<?php if($list[is_show] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('comment','comment_id','<?php echo $list['comment_id']; ?>','is_show',this)"/>
                                        </td>
