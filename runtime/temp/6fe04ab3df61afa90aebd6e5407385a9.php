<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:41:"./application/admin/view3/pickup\add.html";i:1503927232;s:48:"./application/admin/view3/public\min-header.html";i:1510128324;s:48:"./application/admin/view3/public\breadcrumb.html";i:1509608949;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
									...
									<td>
										<select class="di-bl fl seauii" name="province_id" id="province" onChange="get_city(this)">
											...
											<?php if(is_array($province) || $province instanceof \think\Collection || $province instanceof \think\Paginator): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
												<option <?php if($pickup['province_id'] == $p['id']): ?>selected<?php endif; ?>  value="<?php echo $p['id']; ?>"><?php echo $p['name']; ?></option>
										...
										<select class="di-bl fl seauii" name="city_id" id="city" onChange="get_area(this)">
											...
											<?php if(is_array($city) || $city instanceof \think\Collection || $city instanceof \think\Paginator): $i = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
												<option <?php if($pickup['city_id'] == $p['id']): ?>selected<?php endif; ?>  value="<?php echo $p['id']; ?>"><?php echo $p['name']; ?></option>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
										...
										<select class="di-bl fl seauii" name="district_id" id="district">
											...
											<?php if(is_array($district) || $district instanceof \think\Collection || $district instanceof \think\Paginator): $i = 0; $__LIST__ = $district;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
												<option <?php if($pickup['district_id'] == $p['id']): ?>selected<?php endif; ?>  value="<?php echo $p['id']; ?>"><?php echo $p['name']; ?></option>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
										<br>
									</td>
								...
								<tr>
									...
									<td>
										<select class="di-bl fl seauii" name="suppliersid" id="suppliers_id">
											...
											<?php if(is_array($suppliers) || $suppliers instanceof \think\Collection || $suppliers instanceof \think\Paginator): $i = 0; $__LIST__ = $suppliers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?>
												<option <?php if($pickup['suppliersid'] == $s['suppliers_id']): ?>selected="selected"<?php endif; ?>  value="<?php echo $s['suppliers_id']; ?>"><?php echo $s['suppliers_name']; ?></option>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</td>
								</tr>
