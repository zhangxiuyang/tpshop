...
<div class="floor my p edit">
    <form action="<?php echo U('Mobile/User/add_address'); ?>" method="post" id="addressForm">
       ...
       <input type="tel" value="<?php echo $address['mobile']; ?>" name="mobile" onkeyup="this.value=this.value.replace(/[^\d]/g,'')"/>
        ...
        <div class="edita">
            <div class="content30">
                <?php if(!(empty(\think\Request::instance()->param('source')) || ((\think\Request::instance()->param('source') instanceof \think\Collection || \think\Request::instance()->param('source') instanceof \think\Paginator ) && \think\Request::instance()->param('source')->isEmpty()))): ?> <!--如果是下订单时提交过了的页面-->
