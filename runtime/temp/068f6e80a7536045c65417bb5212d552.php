<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"./application/admin/view3/promotion\prom_order_info.html";i:1503927232;s:48:"./application/admin/view3/public\min-header.html";i:1510128324;s:48:"./application/admin/view3/public\breadcrumb.html";i:1509608949;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body ">   
                    <!--表单数据-->
                    <form method="post" id="promotion" action="<?php echo U('Admin/Promotion/prom_order_save'); ?>">                    
                        <!--通用信息-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<?php if(is_array($level) || $level instanceof \think\Collection || $level instanceof \think\Paginator): if( count($level)==0 ) : echo "" ;else: foreach($level as $key=>$vo): ?>
                      						<input type="checkbox" <?php if(strripos($info['group'],$vo['level_id'].'') !== false): ?>checked<?php endif; ?> name="group[]" value="<?php echo $vo['level_id']; ?>"><?php echo $vo['level_name']; ?>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;
