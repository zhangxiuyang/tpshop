<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./application/admin/view3/article\article.html";i:1512109558;s:48:"./application/admin/view3/public\min-header.html";i:1510814014;s:48:"./application/admin/view3/public\breadcrumb.html";i:1509608949;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
                ...
                <form class="form-horizontal" action="<?php echo U('Article/aticleHandle'); ?>" id="add_post" method="post">
                  <div class="box-body">
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-2">
                    		<select class="small form-control" name="cat_id2" id="cat_id2">
                        			<option value="0">选择分类</option>
    								<?php echo $cat_select2; ?> 
                        	</select>
                    	</div>
                    	<div class="col-sm-2" style="width:30%;font-size:10px;color:red">*一篇文章同属于B2B,B2C时, 指定第一个分类属于B2B第二个分类属于B2C</div>
                    </div>
                    <div class="form-group">
