<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:43:"./application/admin/view3/goods\_goods.html";i:1503927232;s:48:"./application/admin/view3/public\min-header.html";i:1509601837;s:48:"./application/admin/view3/public\breadcrumb.html";i:1509608949;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
...
-->                                
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <input type="text" value="<?php echo $tpshop_config[basic_default_storage]; ?>" class="form-control" style="width:150px;" name="store_count" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />                                         
                                        <?php endif; ?>
