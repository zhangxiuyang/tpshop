<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/admin/view3/user\ajaxindex.html";i:1503927232;}*/ ?>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td class="text-left"><?php echo $list['email']; if(($list['email_validated'] == 0) AND ($list['email'])): ?>
                                                (未验证)
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td class="text-left"><?php echo $list['mobile']; if(($list['mobile_validated'] == 0) AND ($list['mobile'])): ?>
                                                (未验证)
                                            <?php endif; ?>
                                        </td>
