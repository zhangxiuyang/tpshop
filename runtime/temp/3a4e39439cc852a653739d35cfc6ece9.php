<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"./application/admin/view3/promotion\flash_sale_info.html";i:1503927232;s:48:"./application/admin/view3/public\min-header.html";i:1510128324;s:48:"./application/admin/view3/public\breadcrumb.html";i:1509608949;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
...
function adsubmit(){
	if($('#title').val() ==''){
		layer.msg('抢购标题不能为空',{icon:2});return;
	}
	if($('#price').val() ==''){
		layer.msg('抢购价格不能为空',{icon:2});return;
	}
	if($('#goods_num').val() ==''){
		layer.msg('参加抢购数量不能为空',{icon:2});return;
	}
	if($('#buy_limit').val() ==''){
		layer.msg('限购数量不能为空',{icon:2});return;
	}
