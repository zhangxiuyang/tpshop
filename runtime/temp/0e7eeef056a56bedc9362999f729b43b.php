<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"./application/admin/view3/goods\ajaxGoodsAttributeList.html";i:1503927232;}*/ ?>
        ...
        <table class="table table-bordered table-hover">
            ...
            <?php if(is_array($goodsAttributeList) || $goodsAttributeList instanceof \think\Collection || $goodsAttributeList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsAttributeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td class="text-center">                        
                        <img width="20" height="20" src="__PUBLIC__/images/<?php if($list[attr_index] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('goods_attribute','attr_id','<?php echo $list['attr_id']; ?>','attr_index',this)"/>
                    </td>                    
                    <td class="text-left">
