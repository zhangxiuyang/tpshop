<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/admin/view3/order\ajaxdelivery.html";i:1503927232;}*/ ?>
                                ...
                                <?php if(is_array($orderList) || $orderList instanceof \think\Collection || $orderList instanceof \think\Paginator): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?php echo U('Admin/order/delivery_info',array('order_id'=>$list['order_id'])); ?>" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="查看详情">去发货</a>
                                        	<?php else: ?>
