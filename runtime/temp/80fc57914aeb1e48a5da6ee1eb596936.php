<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./template/mobile/new2/user\edit_address.html";i:1512112988;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<div class="ed_shdele">
    ...
    <div class="lineq">
        ...
        <span class="sur"><a href="<?php echo U('/Mobile/User/del_address',array('id'=>$address[address_id])); ?>'">确定</a></span>
    </div>
</div>
