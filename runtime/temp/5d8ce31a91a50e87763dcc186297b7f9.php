<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./application/admin/view3/goods\brandList.html";i:1503927232;s:48:"./application/admin/view3/public\min-header.html";i:1509601837;s:48:"./application/admin/view3/public\breadcrumb.html";i:1509608949;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($brandList) || $brandList instanceof \think\Collection || $brandList instanceof \think\Paginator): $i = 0; $__LIST__ = $brandList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td>
                                         <img width="20" height="20" src="__PUBLIC__/images/<?php if($list[is_hot] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('brand','id','<?php echo $list['id']; ?>','is_hot',this)"/>			                             
			            </td>
                                    <td class="text-left">                                         
                                    ...
                                    <td class="text-left">
                                        <a href="<?php echo U('Admin/goods/addEditBrand',array('id'=>$list['id'],'p'=>\think\Request::instance()->param('p'))); ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
