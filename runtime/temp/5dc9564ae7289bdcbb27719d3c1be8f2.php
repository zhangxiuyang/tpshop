<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"./application/admin/view3/goods\categoryList.html";i:1503927232;s:48:"./application/admin/view3/public\min-header.html";i:1509601837;s:48:"./application/admin/view3/public\breadcrumb.html";i:1509608949;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
       ...
       <div class="row">
			...
			<?php if(is_array($cat_list) || $cat_list instanceof \think\Collection || $cat_list instanceof \think\Paginator): if( count($cat_list)==0 ) : echo "" ;else: foreach($cat_list as $k=>$vo): ?>
			  		<tr role="row" align="center" class="<?php echo $vo['level']; ?>" id="<?php echo $vo['level']; ?>_<?php echo $vo['id']; ?>" <?php if($vo[level] > 1): ?>style="display:none"<?php endif; ?>>
                         ...
                         <td>
                             <img width="20" height="20" src="__PUBLIC__/images/<?php if($vo[is_hot] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('goods_category','id','<?php echo $vo['id']; ?>','is_hot',this)"/>
                         </td>
	                 <td>
                             <img width="20" height="20" src="__PUBLIC__/images/<?php if($vo[is_show] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('goods_category','id','<?php echo $vo['id']; ?>','is_show',this)"/>                             
                         </td>
	                     <td>                                 
