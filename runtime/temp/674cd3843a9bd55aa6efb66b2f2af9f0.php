<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"./template/pc/rainbow/article\detail.html";i:1503927244;s:40:"./template/pc/rainbow/public\header.html";i:1503927244;s:40:"./template/pc/rainbow/public\footer.html";i:1503927244;s:46:"./template/pc/rainbow/public\sidebar_cart.html";i:1503927244;}*/ ?>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="item">
						...
						<div class="cata-nav-layer">
							...
							<div class="advertisement_down">
								<?php $pid =10+$kr;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1512108000 and end_time > 1512108000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
...
foreach($result as $key=>$v3):       
    ...
    ?>
							...
							<?php $pid =51;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1512108000 and end_time > 1512108000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
