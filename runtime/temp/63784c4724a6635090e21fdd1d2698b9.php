<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"./application/admin/view3/promotion\search_goods.html";i:1503927232;s:48:"./application/admin/view3/public\min-header.html";i:1510814014;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="navbar navbar-default">
              <form action="<?php echo U('Promotion/search_goods'); ?>" id="search-form2" class="navbar-form form-inline" method="post">
