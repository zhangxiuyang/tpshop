<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/user\remittance.html";i:1503927234;s:44:"./application/admin/view2/public\layout.html";i:1503927232;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
            	<li><a <?php if($status == 1): ?>class="current"<?php endif; ?> href="<?php echo U('remittance',array('status'=>1)); ?>"><span>待转账列表</span></a></li>
            	<li><a <?php if($status == 2): ?>class="current"<?php endif; ?> href="<?php echo U('remittance',array('status'=>2)); ?>"><span>已转账列表</span></a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
