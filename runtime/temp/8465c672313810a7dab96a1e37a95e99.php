<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"./application/admin/view2/promotion\prom_goods_list.html";i:1503927232;s:44:"./application/admin/view2/public\layout.html";i:1503927232;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table>
					...
					<?php if(is_array($prom_list) || $prom_list instanceof \think\Collection || $prom_list instanceof \think\Paginator): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 80px;"><?php echo $vo['prom_desc']; ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="">
								<div style="text-align: center; width: 120px;"><?php echo $vo['status_desc']; ?></div>
							</td>
